...
module.exports = function (grunt) {
      ...
      appMacos: {
        files: [{
          ...
          src: '**'
            ...
            expand: true,
            cwd: 'libraries/mac/',
            dest: '<%= config.dist %>/node-webkit.app/Contents/Frameworks/node-webkit Framework.framework/Libraries',
            src: '**'
        }]
      },
      webkit: {
  ...
  grunt.registerTask('chmod', 'Add lost Permissions.', function () {
    var fs = require('fs');
    fs.chmodSync('dist/proj1.app/Contents/Frameworks/node-webkit Helper EH.app/Contents/MacOS/node-webkit Helper EH', '555');
    fs.chmodSync('dist/proj1.app/Contents/Frameworks/node-webkit Helper NP.app/Contents/MacOS/node-webkit Helper NP', '555');
    fs.chmodSync('dist/proj1.app/Contents/Frameworks/node-webkit Helper.app/Contents/MacOS/node-webkit Helper', '555');
    fs.chmodSync('dist/proj1.app/Contents/MacOS/node-webkit', '555');
  });
  ...
  grunt.registerTask('dmg', 'Create dmg from previously created app folder in dist.', function () {
    var done = this.async();
    var createDmgCommand = 'resources/mac/package.sh "proj1"';
